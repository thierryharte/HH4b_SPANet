...
true_dict = {
    ...
    '5_jets_pt_true_5wp_3L1cuts_allklambda_inclusive': {'name': f"{true_dir_thierry}../spanet_samples/1_14_7_cutcomparison_3L1/h5_allklambda/JetGood_test.h5", 'klambda': 'postEE'},
    '5_jets_pt_true_5wp_3L1cuts_SM_inclusive': {'name': f"{true_dir_thierry}../spanet_samples/1_14_7_cutcomparison_3L1/h5_files_SM/JetGood_test.h5", 'klambda': 'postEE'},
    '5_jets_pt_true_5wp_3L1cuts_kl245_inclusive': {'name': f"{true_dir_thierry}../spanet_samples/1_14_7_cutcomparison_3L1/h5_files_kl245/JetGood_test.h5", 'klambda': 'postEE'},
    '5_jets_pt_true_5wp_3L1cuts_kl5_inclusive': {'name': f"{true_dir_thierry}../spanet_samples/1_14_7_cutcomparison_3L1/h5_files_kl5/JetGood_test.h5", 'klambda': 'postEE'},
    '5_jets_pt_true_inclusive_b_region_postEE_allklambda': {'name': '/eos/user/t/tharte/Analysis_data/spanet_samples/loose_MC_all2022_inclusive_region/postEE/output_JetGood_test.h5', 'klambda': 'postEE'},
}
